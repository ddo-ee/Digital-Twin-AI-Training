...
model = YOLO("Yolov8m_v5.pt") # Or yolov8n.pt, whichever you are using
...
model.export(format="engine", half=True, device=0, imgsz=(544, 960)) # Adjust imsz if you want a different input size (must be a multiple of 32)
